...
Use Ghidra to decompile it to pseudocode C. We find the main function:
  ...
  if (param_1 < 2) {
    ...
    *(undefined1 *)(*(int *)(iVar1 + 0xc) + 0x1f) = 0;
    for (local_20 = 0; *(char *)(*(int *)(param_2 + 4) + local_20) != '\0'; local_20 = local_20 + 1) {
      if (*(char *)(*(int *)(param_2 + 4) + local_20) != *(char *)(*(int *)(iVar1 + 0xc) + local_20)) {
        return 0xffffffff;
      }
    }
    local_34 = 0x539;
...
It is simple to illustrate with Python:
